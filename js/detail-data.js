window.DETAIL_DATA = {
  ...
  "web-debate": {
    category: "网站代表作品",
    title: "历史名人辩论",
    tagline: "裁判视角的 AI 多角色趣味辩论系统",
    status: "需求文档版",
    source: "来源：prd(历史辩论）.md",
    repoUrl: "https://github.com/zxc9802/lishibianlun.git",
    siteUrl: "https://app-8t7lr796lszl.appmiaoda.com/",
    summary:
      "用户可自定义辩题与选手，控制辩论进程并实时打分，最终自动生成结果页与胜负趣味图像。",
    positioning:
      "该项目重在多角色对话编排和互动控制：轮次、评分节点、角色替换、终止判定都可被裁判实时操控。",
    modules: [
      "经典辩题库 + 自定义辩题输入",
      "历史人物库 + 自定义人物加入",
      "轮次化发言与每 5 轮评分机制",
  ...
  "web-recipe": {
    category: "网站代表作品",
    title: "创意食谱 H5",
    tagline: "输入食材与做法，AI 输出味道评分与成品图",
    status: "需求文档版",
    source: "来源：prd(菜谱).md",
    repoUrl: "https://github.com/zxc9802/chuangyicaipu.git",
    siteUrl: "https://app-7ms5uhd87b41.appmiaoda.com",
    summary:
      "通过食材、佐料和烹饪方式输入，自动生成菜品口味推断、星级评价与成品图，支持历史沉淀和分享打卡。",
    positioning:
      "核心价值是把“烹饪创意探索”做成可视化闭环：输入 - 分析 - 评分 - 生图 - 传播。",
    modules: [
      "用户系统：注册登录与个人中心",
      "食材/佐料/用量与烹饪方式输入",
      "AI 口味推断与多维评分",
